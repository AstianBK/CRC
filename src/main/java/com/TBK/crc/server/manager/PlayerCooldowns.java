...
import com.TBK.crc.server.network.messager.PacketSyncCooldown;
...
public class PlayerCooldowns {
    ...
    public Map<String, CooldownInstance> getSkillAbstractCooldowns() {
    ...
    public void addCooldown(MultiArmSkillAbstract power, int durationTicks) {
        powerCooldowns.put(power.name, new CooldownInstance(durationTicks));
    }

    public void addCooldown(MultiArmSkillAbstract power, int durationTicks, int remaining) {
    ...
    public boolean isOnCooldown(MultiArmSkillAbstract power) {
        return powerCooldowns.containsKey(power.name);
    }

    public float getCooldownPercent(MultiArmSkillAbstract power) {
