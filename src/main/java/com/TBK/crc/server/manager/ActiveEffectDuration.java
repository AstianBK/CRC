...
import com.TBK.crc.server.network.messager.PacketActiveEffect;
import com.TBK.crc.server.network.messager.PacketRemoveActiveEffect;
import com.TBK.crc.server.network.messager.PacketSyncDurationEffect;
...
public class ActiveEffectDuration {
    private static final DurationInstance EMPTY = new DurationInstance(MultiArmSkillAbstract.NONE.name, 0, 0, 0);
    ...
    public boolean addDuration(DurationInstance recastInstance, MultiArmCapability powerCap) {
    ...
    @OnlyIn(Dist.CLIENT)
    public void removeDuration(String powerId, MultiArmCapability cap) {
    ...
    @OnlyIn(Dist.CLIENT)
    public void tickDurations(MultiArmCapability skillPlayerCapability) {
    ...
    public boolean hasDurationForSkill(MultiArmSkillAbstract power) {
    ...
    public int getRemainingDurationsForSkill(MultiArmSkillAbstract power) {
    ...
    public void decrementDurationCount(MultiArmSkillAbstract power) {
    ...
    public void removeDuration(DurationInstance recastInstance, DurationResult recastResult, boolean doSync) {
        ...
        MultiArmCapability capability=MultiArmCapability.get(this.serverPlayer);
        if (capability!=null){
