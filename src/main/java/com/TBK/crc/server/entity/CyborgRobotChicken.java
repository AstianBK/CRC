...
public class CyborgRobotChicken extends PathfinderMob {
    public static final EntityDataAccessor<Boolean> CHARGING =
            SynchedEntityData.defineId(CyborgRobotChicken.class, EntityDataSerializers.BOOLEAN);
    ...
    public CyborgRobotChicken(EntityType<? extends PathfinderMob> p_21683_, Level p_21684_) {
    ...
    class AttackGoal extends MeleeAttackGoal {
        ...
        protected void checkAndPerformAttack(LivingEntity p_25557_, double p_25558_) {
            ...
            if (p_25558_ <= d0 && this.getTicksUntilNextAttack()<=0 && CyborgRobotChicken.this.attackTimer<=0) {
        ...
        protected void resetAttackCooldown() {
            ...
            CyborgRobotChicken.this.setAttacking(true);
            if(!CyborgRobotChicken.this.level().isClientSide){
                CyborgRobotChicken.this.playAttack();
            }
        }
    }
}
