...
public class BoomChickenModel<T extends BoomChicken> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = head2.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -2.5F, -1.0F, 4.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.5F, -1.0F));
		...
		PartDefinition right_leg = main.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(20, 1).addBox(-1.5F, 0.0F, -3.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.5F, 2.0F, 0.0F));

		PartDefinition body = main.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 7).addBox(-2.5F, -3.0F, -5.0F, 5.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, -3.0F, -1.0F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition body_r1 = bombs.addOrReplaceChild("body_r1", CubeListBuilder.create().texOffs(26, 7).addBox(0.0F, -1.5F, -1.0F, 0.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.7081F, -0.95F, -0.9783F, 0.3927F, 0.0F, -1.5708F));

		PartDefinition body_r2 = bombs.addOrReplaceChild("body_r2", CubeListBuilder.create().texOffs(26, 7).addBox(0.0F, -2.0F, -1.5F, 0.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.4375F, 1.05F, -0.325F, 0.3927F, 0.0F, -1.5708F));

		PartDefinition body_r3 = bombs.addOrReplaceChild("body_r3", CubeListBuilder.create().texOffs(26, 12).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(-2.1625F, 1.0F, 0.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition body_r4 = bombs.addOrReplaceChild("body_r4", CubeListBuilder.create().texOffs(30, 9).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2625F, 1.0F, 0.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition tnt = bombs.addOrReplaceChild("tnt", CubeListBuilder.create(), PartPose.offset(0.2625F, -1.0F, 0.0F));

		PartDefinition body_r5 = tnt.addOrReplaceChild("body_r5", CubeListBuilder.create().texOffs(30, 9).mirror().addBox(-1.0F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition body_r6 = tnt.addOrReplaceChild("body_r6", CubeListBuilder.create().texOffs(26, 12).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(-2.425F, 0.0F, 0.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition left_wing = main.addOrReplaceChild("left_wing", CubeListBuilder.create().texOffs(18, 9).mirror().addBox(0.0F, -1.5F, 0.0F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(4.5F, -0.5F, -4.0F));

		PartDefinition right_wing = main.addOrReplaceChild("right_wing", CubeListBuilder.create().texOffs(18, 9).addBox(-1.0F, -1.5F, 0.0F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.5F, -0.5F, -4.0F));

		PartDefinition left_leg = main.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(20, 1).addBox(-1.5F, 0.0F, -3.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(3.5F, 2.0F, 0.0F));
