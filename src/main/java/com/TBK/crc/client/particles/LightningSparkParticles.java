...
public class LightningSparkParticles extends TextureSheetParticle {
    private final SpriteSet sprites;

    protected LightningSparkParticles(ClientLevel p_108484_, double p_108485_, double p_108486_, double p_108487_, double xSpeed, double ySpeed, double zSpeed , SpriteSet spriteSet) {
